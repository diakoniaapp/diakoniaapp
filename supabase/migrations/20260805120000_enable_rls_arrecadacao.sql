...
-- (tem_permissao()). Testado manualmente antes do merge; rollback documentado
-- no final deste arquivo (comentado).

-- ============================================================
-- BLOCO 1 -- arr_reservas (politicas ja existiam, so faltava o RLS)
-- ============================================================
ALTER TABLE public.arr_reservas ENABLE ROW LEVEL SECURITY;

-- ============================================================
-- BLOCO 2 -- tabelas de catalogo/configuracao: leitura ampla, escrita restrita
-- ============================================================
...
-- Tabelas operacionais (ligadas a reserva/caixa): mesmo padrao de acesso do arr_reservas
...
-- ============================================================
-- ROLLBACK (nao execute junto -- so se precisar desfazer)
-- ============================================================
