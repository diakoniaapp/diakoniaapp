...
| 7 | **Importação de extrato (OFX/CSV)** | alto | depende do item 3 da lista de decisões — agora que a conciliação manual (ex-item 6) existe, isto é "conciliação automática *a partir* de um arquivo", não mais do zero |
