        ...
        <Card className="border-amber-200 bg-amber-50/40 dark:bg-amber-950/10">
          <CardContent className="py-3 space-y-2">
            ...
            <div className="space-y-1.5 max-h-40 overflow-y-auto">
              {sugestoes.map(s => (
                <div key={s.pessoa_id} className="flex items-center justify-between gap-2 text-sm border-b border-amber-200/40 pb-1.5 last:border-0">
                  <div className="min-w-0">
            ...
            <div className="flex items-center gap-1.5 pt-1">
              {pessoaId && (
                <Button type="button" size="sm" variant="outline" onClick={abrirVincCriarNova} className="gap-1.5 text-xs">
                  <Users className="w-3 h-3" /> Criar nova família
                </Button>
              )}
