...
{ value: "voluntario", label: "Voluntario", tipos: ["membro", "congregado"] },
{ value: "lideranca", label: "Lider", tipos: ["membro"] },
...
// Sugestão pastor ao selecionar perfil
useEffect(() => {
...
// Validacao: pastor precisa de data de consagracao
if (form.perfil_acesso === "pastor" && !form.data_consagracao_pastoral) {
return toast.error("Informe a data de consagracao pastoral para pastores");
}
...
// Limpar data_consagracao_pastoral se nao for pastor
if (payload.perfil_acesso !== "pastor") {
payload.data_consagracao_pastoral = null;
}
...
// Perfis disponíveis de acordo com o tipo de pessoa
...
{/* ── SEÇÃO: TIPO E PERFIL ── */}
<Section title="Identificacao" icon={UserCircle}>
...
Cadastro rapido. Pode ser convertido depois.
</p>
)}
</div>

{/* Perfil (funcao) — apenas membro */}
{isMembro && (
<div className="space-y-1.5">
<Label translate="no">Funcao / Perfil</Label>
...
Deseja incluir este pastor como lideranca da igreja? Preencha a data de consagracao abaixo e depois acesse o Organograma para vincular.
</p>
</div>
</div>
)}
...
{/* ── SEÇÃO: DADOS ECLESIASTICOS (congregado e membro) ── */}
{(isCongregado || isMembro) && (
<Section title="Dados Eclesiasticos" icon={Church} collapsible defaultOpen>
<div className="grid md:grid-cols-2 gap-4">
...
<div className="space-y-1.5">
<Label translate="no">Data de batismo</Label>
<Input
type="date"
...
{/* ── Campo PASTOR: Data de consagracao ── */}
{isPastor && (
<div className="space-y-1.5 md:col-span-2">
<Label translate="no" className="flex items-center gap-2">
<Star className="h-4 w-4 text-amber-500" />
Data de consagracao pastoral *
</Label>
<Input
type="date"
value={form.data_consagracao_pastoral}
...
Obrigatorio para pastores. Data em que foi oficialmente consagrado.
</p>
</div>
)}
...
<Section title="Familia" icon={Users} collapsible defaultOpen={false}>
<FamiliaSection
pessoaId={membro.id}
...
<Button type="button" variant="outline" onClick={() => onOpenChange(false)} disabled={busy} className="sm:ml-auto">
Cancelar
</Button>
