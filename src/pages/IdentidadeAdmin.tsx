      ...
      <div className="p-4 md:p-8 space-y-6 max-w-2xl">
        ...
        <Card className="shadow-card-soft">
          ...
          <CardContent className="space-y-3">
            ...
            {/* Pastor já vinculado */}
            {pastorId && (
              <div className="flex items-center gap-3 rounded-md bg-success-soft/30 border border-success-line px-3 py-2.5">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-start gap-2 rounded-md bg-muted/50 border px-3 py-2.5">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                Instituições com <Zap className="inline w-3 h-3 text-warning-text" /> permitem integração futura com agenda.
              </p>
            </div>
            ...
            {isAdmin && (
              adicionandoInst ? (
                <div className="rounded-md border p-4 space-y-3 bg-muted/20">
                  ...
                  {sugestoes.length > 0 && (
                    <div className="rounded-md border border-warning-line bg-warning-soft/20 p-3 space-y-2">
